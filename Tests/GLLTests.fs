  ...
  testList "GLL CFPQ Tests with SPPF" [
    ...
    testCase "Graph with branch, RSM with nonterminal, nodes reusing" <| fun () ->
        ...
        let expected =
          ...
          nodes.Add(1, TriplesStoredSPPFNode.TerminalNode (0<graphVertex>,0<terminalSymbol>,1<graphVertex>))
          nodes.Add(2, TriplesStoredSPPFNode.RangeNode (0<graphVertex>,4<graphVertex>,0<rsmState>,2<rsmState>))
          ...
          nodes.Add(6, TriplesStoredSPPFNode.RangeNode (1<graphVertex>,4<graphVertex>,1<rsmState>,2<rsmState>))
          nodes.Add(7, TriplesStoredSPPFNode.NonTerminalNode (1<graphVertex>,0<rsmState>,4<graphVertex>))
          nodes.Add(8, TriplesStoredSPPFNode.RangeNode (1<graphVertex>,4<graphVertex>,0<rsmState>,2<rsmState>))
          nodes.Add(9, TriplesStoredSPPFNode.TerminalNode (1<graphVertex>,0<terminalSymbol>,4<graphVertex>))
          nodes.Add(10, TriplesStoredSPPFNode.RangeNode (0<graphVertex>,2<graphVertex>,0<rsmState>,2<rsmState>))
          nodes.Add(11, TriplesStoredSPPFNode.IntermediateNode (1<graphVertex>,1<rsmState>))
          nodes.Add(12, TriplesStoredSPPFNode.RangeNode (1<graphVertex>,2<graphVertex>,1<rsmState>,2<rsmState>))
          nodes.Add(13, TriplesStoredSPPFNode.NonTerminalNode (1<graphVertex>,0<rsmState>,2<graphVertex>))
          nodes.Add(14, TriplesStoredSPPFNode.RangeNode (1<graphVertex>,2<graphVertex>,0<rsmState>,2<rsmState>))
          nodes.Add(15, TriplesStoredSPPFNode.TerminalNode (1<graphVertex>,0<terminalSymbol>,2<graphVertex>))
          nodes.Add(16, TriplesStoredSPPFNode.IntermediateNode (4<graphVertex>,1<rsmState>))
          nodes.Add(17, TriplesStoredSPPFNode.RangeNode (1<graphVertex>,4<graphVertex>,0<rsmState>,1<rsmState>))
          nodes.Add(18, TriplesStoredSPPFNode.TerminalNode (1<graphVertex>,0<terminalSymbol>,4<graphVertex>))
          nodes.Add(19, TriplesStoredSPPFNode.RangeNode (4<graphVertex>,2<graphVertex>,1<rsmState>,2<rsmState>))
          nodes.Add(20, TriplesStoredSPPFNode.NonTerminalNode (4<graphVertex>,0<rsmState>,2<graphVertex>))
          nodes.Add(21, TriplesStoredSPPFNode.RangeNode (4<graphVertex>,2<graphVertex>,0<rsmState>,2<rsmState>))
          nodes.Add(22, TriplesStoredSPPFNode.TerminalNode (4<graphVertex>,0<terminalSymbol>,2<graphVertex>))
          nodes.Add(23, TriplesStoredSPPFNode.RangeNode (0<graphVertex>,3<graphVertex>,0<rsmState>,2<rsmState>))
          nodes.Add(24, TriplesStoredSPPFNode.IntermediateNode (1<graphVertex>,1<rsmState>))
          nodes.Add(25, TriplesStoredSPPFNode.RangeNode (1<graphVertex>,3<graphVertex>,1<rsmState>,2<rsmState>))
          nodes.Add(26, TriplesStoredSPPFNode.NonTerminalNode (1<graphVertex>,0<rsmState>,3<graphVertex>))
          nodes.Add(27, TriplesStoredSPPFNode.RangeNode (1<graphVertex>,3<graphVertex>,0<rsmState>,2<rsmState>))
          nodes.Add(28, TriplesStoredSPPFNode.IntermediateNode (4<graphVertex>,1<rsmState>))
          nodes.Add(29, TriplesStoredSPPFNode.RangeNode (4<graphVertex>,3<graphVertex>,1<rsmState>,2<rsmState>))
          nodes.Add(30, TriplesStoredSPPFNode.NonTerminalNode (4<graphVertex>,0<rsmState>,3<graphVertex>))
          nodes.Add(31, TriplesStoredSPPFNode.RangeNode (4<graphVertex>,3<graphVertex>,0<rsmState>,2<rsmState>))
          nodes.Add(32, TriplesStoredSPPFNode.IntermediateNode (2<graphVertex>,1<rsmState>))
          nodes.Add(33, TriplesStoredSPPFNode.RangeNode (4<graphVertex>,2<graphVertex>,0<rsmState>,1<rsmState>))
          nodes.Add(34, TriplesStoredSPPFNode.TerminalNode (4<graphVertex>,0<terminalSymbol>,2<graphVertex>))
          nodes.Add(35, TriplesStoredSPPFNode.RangeNode (2<graphVertex>,3<graphVertex>,1<rsmState>,2<rsmState>))
    ...
    testCase "Minimal example of interprocedural control flow." <| fun () ->
        ...
        let expected =
          ...
          nodes.Add(52, TriplesStoredSPPFNode.RangeNode (0<graphVertex>,6<graphVertex>,0<rsmState>,0<rsmState>))
          nodes.Add(53, TriplesStoredSPPFNode.IntermediateNode (4<graphVertex>,0<rsmState>))
          nodes.Add(54, TriplesStoredSPPFNode.RangeNode (4<graphVertex>,6<graphVertex>,0<rsmState>,0<rsmState>))
          nodes.Add(55, TriplesStoredSPPFNode.TerminalNode (4<graphVertex>,1<terminalSymbol>,6<graphVertex>))
          nodes.Add(56, TriplesStoredSPPFNode.IntermediateNode (7<graphVertex>,0<rsmState>))
          nodes.Add(57, TriplesStoredSPPFNode.RangeNode (0<graphVertex>,7<graphVertex>,0<rsmState>,0<rsmState>))
          nodes.Add(58, TriplesStoredSPPFNode.IntermediateNode (6<graphVertex>,0<rsmState>))
          nodes.Add(59, TriplesStoredSPPFNode.RangeNode (7<graphVertex>,6<graphVertex>,0<rsmState>,0<rsmState>))
          nodes.Add(60, TriplesStoredSPPFNode.TerminalNode (7<graphVertex>,3<terminalSymbol>,6<graphVertex>))
          nodes.Add(61, TriplesStoredSPPFNode.RangeNode (0<graphVertex>,9<graphVertex>,0<rsmState>,0<rsmState>))
          nodes.Add(62, TriplesStoredSPPFNode.IntermediateNode (7<graphVertex>,0<rsmState>))
          nodes.Add(63, TriplesStoredSPPFNode.IntermediateNode (8<graphVertex>,0<rsmState>))
          nodes.Add(64, TriplesStoredSPPFNode.RangeNode (0<graphVertex>,8<graphVertex>,0<rsmState>,0<rsmState>))
          nodes.Add(65, TriplesStoredSPPFNode.IntermediateNode (10<graphVertex>,4<rsmState>))
          nodes.Add(66, TriplesStoredSPPFNode.RangeNode (0<graphVertex>,10<graphVertex>,0<rsmState>,4<rsmState>))
          nodes.Add(67, TriplesStoredSPPFNode.IntermediateNode (6<graphVertex>,3<rsmState>))
          nodes.Add(68, TriplesStoredSPPFNode.RangeNode (0<graphVertex>,6<graphVertex>,0<rsmState>,3<rsmState>))
          nodes.Add(69, TriplesStoredSPPFNode.IntermediateNode (7<graphVertex>,0<rsmState>))
          nodes.Add(70, TriplesStoredSPPFNode.RangeNode (0<graphVertex>,10<graphVertex>,0<rsmState>,0<rsmState>))
          nodes.Add(71, TriplesStoredSPPFNode.IntermediateNode (9<graphVertex>,0<rsmState>))
          nodes.Add(72, TriplesStoredSPPFNode.RangeNode (0<graphVertex>,3<graphVertex>,0<rsmState>,0<rsmState>))
          nodes.Add(73, TriplesStoredSPPFNode.IntermediateNode (2<graphVertex>,0<rsmState>))
          nodes.Add(74, TriplesStoredSPPFNode.RangeNode (2<graphVertex>,3<graphVertex>,0<rsmState>,0<rsmState>))
          nodes.Add(75, TriplesStoredSPPFNode.TerminalNode (2<graphVertex>,0<terminalSymbol>,3<graphVertex>))
