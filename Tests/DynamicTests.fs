...
//        let graphEntryPoint = LinearInputGraphVertexBase() :> ILinearInputGraphVertex
//        let graphExit = LinearInputGraphVertexBase() :> ILinearInputGraphVertex
//        graphEntryPoint.OutgoingEdge.Add(terminalForCFGEdge, HashSet [|TerminalEdgeTarget graphExit|])
//
...
//        graphEntryPoint.OutgoingEdge.Clear()
//        let secondMethodEntryPoint = LinearInputGraphVertexBase () :> ILinearInputGraphVertex
//        let secondMethodExit = LinearInputGraphVertexBase () :> ILinearInputGraphVertex
//        secondMethodEntryPoint.OutgoingEdge.Add(terminalForCFGEdge, HashSet [|TerminalEdgeTarget secondMethodExit|])
//        graphEntryPoint.OutgoingEdge.Add(1<terminalSymbol>, HashSet [|TerminalEdgeTarget secondMethodEntryPoint|])
//        secondMethodExit.OutgoingEdge.Add(2<terminalSymbol>, HashSet [|TerminalEdgeTarget graphExit|])
